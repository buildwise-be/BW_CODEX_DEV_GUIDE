...
1. Reformuler la demande en langage métier.
2. Identifier l’utilisateur, le problème et le résultat attendu.
3. Proposer une première version limitée et vérifiable.
4. Poser seulement les questions fonctionnelles indispensables.
5. Construire la fonctionnalité avec les composants existants.
6. Vérifier les états normal, chargement, erreur et absence de données.
7. Vérifier le rendu responsive et la cohérence Buildwise.
8. Mettre à jour la documentation et les critères de validation.
9. Résumer ce qui est livré, ce qui reste à décider et la prochaine action.
